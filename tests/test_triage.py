...
@pytest.mark.parametrize("pdf_path, expected_origin, expected_layout, expected_domain", [
    ("tests/test_data/2022_Audited_Financial_Statement_Report.pdf", OriginType.SCANNED_IMAGE, LayoutComplexity.SINGLE_COLUMN, DomainHint.GENERAL),
    ("tests/test_data/fta_performance_survey_final_report_2022.pdf", OriginType.NATIVE_DIGITAL, LayoutComplexity.SINGLE_COLUMN, DomainHint.FINANCIAL),
    ("tests/test_data/tax_expenditure_ethiopia_2021_22.pdf", OriginType.NATIVE_DIGITAL, LayoutComplexity.SINGLE_COLUMN, DomainHint.FINANCIAL),
])
